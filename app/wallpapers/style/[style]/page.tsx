...
const COPY: Record<GradientStyle, { title: string; description: string; body: string[] }> = {
  blobs: {
    ...
    description:
      "Free mesh gradient wallpapers in 4K, 5K and phone sizes. Soft overlapping color fields with real grain, no watermark, no sign-up.",
    body: [
      "Blobs are the classic mesh gradient: several color points spread across the canvas and blurred into each other. They make calm, glowing backgrounds that sit well behind icons and windows.",
  ...
  clouds: {
    ...
    body: [
      "Clouds are built from fractal noise mapped through the palette, so masses have real depth and the edges wisp instead of blobbing. They work best with a sky color and two or three highlight tones.",
