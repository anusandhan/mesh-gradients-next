...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // rounded-xl (12px) with p-6 - inner surfaces at rounded-lg stay
        // concentric enough for the 24px padding
        // slide-in/out-from-left-1/2 + top-[48%] keep the centering translate
        // inside the animation keyframes; without them the zoom keyframes
        // override -translate-x/y-1/2 and the dialog enters off-center
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-3 top-3 rounded-lg p-2 text-neutral-400 transition-colors hover:text-neutral-800 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
        aria-label="Close"
      >
